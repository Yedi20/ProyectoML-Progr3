...
#-------------metodos usados en el entrenamiento y lectura d el modelo---
method = 'EigenFaces'
#method = 'FisherFaces'
#method = 'LBPH'
...
#cap = cv2.VideoCapture('Imgenes y Video de prueba/bailariniaTest0.mp4')
	...
	for (x,y,w,h) in faces:
		...
		if method == 'EigenFaces':
			...
			if result[1] < 5700:
				...
				image = EmotiomImage(imagePaths[result[0]])
...
#python ReconocimientoEmociones.py